...
// Zdroj: "Strunne nastroje", "Elektro_akusticke nastroje", "Uvod do ZI".
...
const zin6CrackData = [
  // ===== Klasicka gitara (3) =====
  {
    ...
    nepravda2: "Klasicka gitara: 6 strun E, A, d, g, h, e1 - kvarty s velkou terciou medzi h a e1."
  },
  {
    ...
    nepravda2: "Klasicka gitara: nylonove struny (basove opradane), siroky plochy hmatnik; znie tak, ako sa pise."
  },
  {
    ...
    nepravda2: "Hra prstami pravej ruky: apoyando (oprety uder) a rasgueado (volny uder)."
  },
  ...
  // ===== Odvodene nastroje (5) =====
  {
    ...
    nepravda: "Westernova (akusticka): nylonove struny, hra trsatkom, vystuzna tyc (truss rod) v krku, typ dreadnought.",
    nepravda2: "Westernova (akusticka): ocelove struny, hra trsatkom, krk bez vystuznej tyce, typ dreadnought."
  },
  {
    ...
    nepravda2: "Elektricka: single coil = zivsi, ostrejsi, ale brumovy; humbucker = 2 civky v rovnakom vinuti, rusenie sa odcita."
  },
  {
    ...
    nepravda: "Elektricka: prepinac snimacov, potenciometre volume/tone, packa vibrata; tvar a dutost tela zvuk neovplyvnuju.",
    nepravda2: "Elektricka: prepinac snimacov, potenciometre gain a master, packa vibrata; dute telo pridava rezonanciu skrine."
  },
  {
    ...
    nepravda2: "Basgitara: 4 struny E1, A1, D, G v kvartach (ako kontrabas); znie tak, ako sa pise; aj bezprazcova (fretless)."
  },
  {
    ...
    nepravda2: "Techniky basgitary: prsty (apoyando), trsatko, slap and pop, palm muting."
  },
  ...
  // ===== Dalsie drnkacie (6) =====
  {
    ...
    nepravda2: "Dalsie drnkacie: mandolina, banjo, ukulele, lutna, theorba, harfa, citera, balalajka, sitar, ninera."
  },
  {
    ...
    nepravda2: "Mandolina: 4 zdvojene zbory ladene ako husle (g, d1, a1, e2); typicke vibrato."
  },
  {
    ...
    nepravda: "Banjo: drevena rezonancna doska namiesto blany; najcastejsie ladenie open G (g, D, G, H, d).",
    nepravda2: "Banjo: blana namiesto drevenej dosky; najcastejsie ladenie open D (f#, D, F#, A, d)."
  },
  {
    ...
    nepravda2: "Ukulele: 4 nylonove struny g, c1, e1, a1; velkosti sopran, alt, tenor, baryton."
  },
  {
    ...
    nepravda: "Lutna: rovny krk, zdvojene zbory, kvartovo-terciove ladenie; theorba = basova lutna (continuo).",
    nepravda2: "Lutna: zalomeny krk, zdvojene zbory, kvartovo-terciove ladenie; theorba = sopranova lutna (continuo)."
  },
  {
    ...
    nepravda2: "Harfa: drnkacia bez hmatnika; 46 strun diatonicky v Ces dur; 7 pedalov s 3 polohami (+polton, +2 poltony)."
  },
  ...
  // ===== Tabulatura (4) =====
  {
    ...
    nepravda2: "Tabulatura: linky = struny, cisla = prazce, 0 = tlmena struna."
  },
  {
    ...
    nepravda2: "TAB: gitara 6 liniek, basgitara 5; najnizsia struna na spodnej linke."
  },
  {
    ...
    nepravda2: "Tabulatura zapisuje hmat (miesto hrania), nie absolutnu vysku; rytmus sa v tabulature zasadne nezapisuje."
  },
  {
    ...
    nepravda2: "Historicke organove tabulatury: francuzska pismena, talianska cisla."
  }
];
