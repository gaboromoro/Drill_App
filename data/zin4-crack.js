...
// 17 statementov, telegraficky styl. Zdroj: prezentacia "Zeste".
...
const zin4CrackData = [
  ...
  },
  {
    ...
    nepravda: "Zdroj tonu: kovovy jazycek vnutri natrubku; vysledny signal sa blizi pile."
  },
  {
  ...
  // ===== Individualne odlisnosti (6) =====
  {
    ...
    nepravda: "Trubka: 4 pisty, prevazne kuzelova menzura - makka farba."
  },
  {
    ...
    nepravda: "Lesny roh: stocena trubica vyse 4 m, ventily pre pravu ruku, lava ruka v roztrube, miskovity natrubok."
  },
  {
    ...
    nepravda: "Dvojity roh F/Es s kvintovou (palcovou) klapkou; v orchestri kvarteto - 1. a 2. vysoko, 3. a 4. nizko."
  },
  {
  ...
  },
  {
    ...
    nepravda: "Tuba: najhlbsi zest orchestra; valcova menzura, uzky roztrub smerom dopredu."
  },
  {
  ...
  // ===== Ladenie, notacia, rozsah (4) =====
  {
    ...
    podoblast: "Nastroje",
    pravda: "Trubka in B: znie o velku sekundu nizsie; huslovy kluc; pisany rozsah cca e az c3.",
    nepravda: "Trubka in B: znie o velku sekundu vyssie; huslovy kluc; pisany rozsah cca e az c3."
  },
  {
    ...
    nepravda: "Lesny roh in F: znie o cistu kvartu nizsie; huslovy kluc; rozsah priblizne dve oktavy."
  },
  {
    ...
    nepravda: "Pozoun: transponuje in B; huslovy kluc; rozsah cca E az b1 + pedalove tony."
  },
  {
    ...
    nepravda: "Tuba: transponuje in F; basovy kluc; stavia sa len v ladeni B."
  }
];
